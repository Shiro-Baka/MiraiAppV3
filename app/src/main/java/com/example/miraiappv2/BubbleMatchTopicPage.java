...
//Declares the gridlayout from the xml file
        ...
        ToggleButton essentialToggleButton = findViewById(R.id.toggle_button_bubble_match_topic_essential);
        ToggleButton coloursToggleButton = findViewById(R.id.toggle_button_bubble_match_topic_colours);
        ToggleButton numbersToggleButton = findViewById(R.id.toggle_button_bubble_match_topic_numbers);
        ToggleButton adjectivesToggleButton = findViewById(R.id.toggle_button_bubble_match_topic_adjectives);
        ToggleButton animalsToggleButton = findViewById(R.id.toggle_button_bubble_match_topic_animals);
        ToggleButton dwmyToggleButton = findViewById(R.id.toggle_button_bubble_match_topic_dwmy);
        ToggleButton foodDrinkToggleButton = findViewById(R.id.toggle_button_bubble_match_topic_food_drink);
        ToggleButton greetingsToggleButton = findViewById(R.id.toggle_button_bubble_match_topic_greetings);
        ToggleButton generalToggleButton = findViewById(R.id.toggle_button_bubble_match_topic_general);
        ToggleButton schoolToggleButton = findViewById(R.id.toggle_button_bubble_match_topic_school);
        ToggleButton verbsToggleButton = findViewById(R.id.toggle_button_bubble_match_topic_verbs);
        ToggleButton bodyPartsToggleButton = findViewById(R.id.toggle_button_bubble_match_topic_body_parts);
        ToggleButton familyCountingToggleButton = findViewById(R.id.toggle_button_bubble_match_topic_family_counting);
        ToggleButton seasonsWeatherToggleButton = findViewById(R.id.toggle_button_bubble_match_topic_seasons_weather);
    ...
    public void startQuiz(View view) {
        ...
        Intent intent = new Intent(this, BubbleMatchGamePage.class);
        ...
        if (selectedTopics.size() == 0) {
            ...
            View toastLayout = getLayoutInflater().inflate(R.layout.bubble_match_popup, (ViewGroup) findViewById(R.id.toast_layout_root));
