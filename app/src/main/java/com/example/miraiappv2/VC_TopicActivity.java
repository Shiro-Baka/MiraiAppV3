...
public class VC_TopicActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //set the view
        setContentView(R.layout.activity_vc_topic);
        ...
        beginGame.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (beginGame.isPressed() && topicselected == false){
                    Toast.makeText(VC_TopicActivity.this, "Please Select one or more topics",
                            Toast.LENGTH_SHORT).show();
                }else{
                    String topics = TextUtils.join(",",all_topics);
                    String language = getIntent().getStringExtra("language");
                    Intent intent = new Intent(getApplicationContext(), VC_GameActivity.class);
